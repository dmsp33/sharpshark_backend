...
class EthereumRepository implements BlockchainInterface
{
	private $client;
	private $baseUrl;
	...
	public function __construct()
	{
		...
		$this->baseUrl = env("BLOCKCHAIN_ETHERIUM_BASE_URL", "");
	}

	public function send(string $ipfsHash)
	{
		if (empty($this->baseUrl)) {
			throw new Exception("Etherium blockchain is not configured yet");
		} else {
			try {
				...
				*/
				...
				throw new Exception('Error al enviar a red ethereum');
			}
		}		
	}
